...
## ✅ BUG RESUELTO (S4-10) — calificaciones no distinguía grupo
Resuelto el 2026-06-17. Columna `grupo` + migración 003 + endpoint confirmar
filtra por grupo + generador filtra por grupo + dedup co-dictado. Validado:
ÁLGEBRA LINEAL conserva sus 4 grupos. Commit 8669040.
